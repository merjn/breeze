...
$app->singleton(
    ...
    Breeze\Web\SharedResources\Console\Kernel::class
);
...
$themeNamespace = sprintf("Breeze\Web\%s", $theme);
 ...
 */
$app->singleton(
    abstract: Breeze\Web\SharedResources\Config\ServiceProviderRegistryInterface::class,
